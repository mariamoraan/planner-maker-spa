...
export default function LandingPage() {
  ...
  const amarkItems = t('landing.compare.amark.items', { returnObjects: true }) as string[];
      ...
      <section id="compare" className="landing-page__section landing-page__section--white">
        <div className="landing-page__container">
          ...
          <div className="landing-page__compare-grid">
            ...
            <motion.div
              className="landing-page__compare-card landing-page__compare-card--amark"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeUp}
            ...
            >
              ...
              <h3>{t('landing.compare.amark.title')}</h3>
              <ul>
                {amarkItems.map(item => (
                  <li key={item}>{item}</li>
                ))}
