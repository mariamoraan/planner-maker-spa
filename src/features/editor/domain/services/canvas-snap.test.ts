...
import { computeSnap, computeGroupSnap, computeGroupBounds, normalizeCoord, canonicalGap, sanitizeRectangleGeometry } from '@/features/editor/domain/services/canvas-snap';
import type { RectBounds, GroupMember } from '@/features/editor/domain/services/canvas-snap';
