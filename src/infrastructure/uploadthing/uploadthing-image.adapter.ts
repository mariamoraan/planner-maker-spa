import { getFirebaseIdToken } from '@/infrastructure/firebase/get-id-token';
import type { ImageAssetPort, ImageRef } from '../ports/image-asset.port';
import { pageIdFromImageRefKey } from '../ports/image-asset.port';
import { resolveImageDeleteUrl, uploadFiles } from './uploadthing-client';
